...
class Evaluator:
    ...
    def init_path(self):
        ...
        uncertainty_folder = join(experiment_path ,'uncertainty' )
        point_predict_folder =join( experiment_path , 'point_predict' )
    ...
    def init_model(self):
        ...
        #!+============
        #* new load code 
        # from .train_cylinder_asym_ood_final2 import load_ckpt
        # ckpt = load_ckpt(self.args.load_path)
