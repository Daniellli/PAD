    ...
    with torch.no_grad():
        for i_iter_val, (_, val_vox_label, val_grid, val_pt_labs, val_pt_fea, idx) in enumerate(
            ...
            point_uncertainty.tofile(
                '/harddisk/jcenaa/nuScenes/predictions/scores_softmax_dropout_5/' + idx_s + '.label')
            point_predict.tofile(
                '/harddisk/jcenaa/nuScenes/predictions/predictions_softmax_dropout_5/' + idx_s + '.label')
