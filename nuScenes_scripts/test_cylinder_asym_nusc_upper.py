...
def main(args):
    ...
    with torch.no_grad():
        for i_iter_val, (_, val_vox_label, val_grid, val_pt_labs, val_pt_fea, sd_token) in enumerate(
            ...
            predict_labels = my_model.forward(val_pt_fea_ten, val_grid_ten, val_batch_size)
            ...
            point_predict.tofile(
                '/harddisk/jcenaa/nuScenes/predictions/predictions_upper_test/' + idx_s + '_lidarseg.bin')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-y', '--config_path', default='../config/nuScenes_test.yaml')
