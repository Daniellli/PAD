...
def main(args):
    ...
    while epoch < train_hypers['max_num_epochs']:
        ...
        for i_iter, train_temp in enumerate(train_dataset_loader):
            (_, train_vox_label, train_grid, _, train_pt_fea) = train_temp
            if global_iter % check_iter == 0 and epoch >= 0:
                ...
                val_loss_list = []
                with torch.no_grad():
                    for i_iter_val, val_temp in enumerate(val_dataset_loader):
                        (_, val_vox_label, val_grid, val_pt_labs, val_pt_fea, _) = val_temp
                        ...
                        progressBar(i_iter_val, len(val_dataset_loader), 'val')
                my_model.train()
                ...
                del val_vox_label, val_grid, val_pt_fea, val_grid_ten, val_temp
