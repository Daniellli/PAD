    ...
    with torch.no_grad():
        for i_iter_val, (_, val_vox_label, val_grid, val_pt_labs, val_pt_fea, idx) in enumerate(
            ...
            point_predict.tofile(
                '../../semantic_kitti/predictions/sequences/08/predictions_base_train/' + idx_s + '.label')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-y', '--config_path', default='config/semantickitti_ood_generate_incre_labels.yaml')
